...
class DataTransformation:
    ...
    def get_data_transformerf_object(self):
        try:
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info("Read train and test data cmpleted")
            
            logging.info("Obtaining preprcessing object")
            
            preprocessing_obj = self.get_data_transformerf_object()
